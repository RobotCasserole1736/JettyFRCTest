...
public class AcqSpec {
	...
	/**
	 * Declare a specification for how an acquisition list ought to be returning samples to 
	 * the requesting client. A signal may use this info as well to determine how 
	 * long to keep samples around
