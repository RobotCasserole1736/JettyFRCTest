...
public class IDGen{
	...
	/**
	 *  Utility to generate a string UUID from a starting string "suggestion".
	 *  The goal is to generate something still human readable so debugging is 
	 *  not frustrating, but still generate a true UUID that can be used as such.
